    ...
    <View style={styles.screen}>
      ...
      <ScreenScroll contentStyle={styles.scroll}>
        ...
        <DisclaimerCard compact title="Not legal advice">
          {LEGAL_DISCLAIMER_SHORT} Summaries are generated from public excerpts; answers in Ask still
          come only from statutes, regulations, and policy manual sources—not press releases.
        </DisclaimerCard>
