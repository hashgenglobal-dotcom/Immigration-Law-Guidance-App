...
- PDF format (requires OCR + text extraction)
- Organized by year + volume (Matter of ___)

### Challenges
- PDF parsing (some scanned, some text-based)
- Citation extraction (e.g., "Matter of A-B-, 27 I&N Dec. 316")
- Topic classification (asylum, removal, waivers, etc.)

### Timeline
- Crawler + PDF parser: 3-4 hours
- Text extraction + chunking: 2 hours
- Database insert: 30 min
- Embeddings: 20-30 min
- **Total:** ~6-8 hours
...
- Multi-source legal database (10K+ chunks)
...
2. 📋 INA ingestion — Start with GovInfo API
3. 📋 BIA decisions — PDF parsing challenge
4. 📋 Frontend integration — Connect RAG to UI
