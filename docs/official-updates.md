...
This document describes how Official Updates works end-to-end: data model, ingest, API, mobile UI, topic filters, privacy, and operations. This MVP does not change Ask chat behavior or prefill the Ask composer.
